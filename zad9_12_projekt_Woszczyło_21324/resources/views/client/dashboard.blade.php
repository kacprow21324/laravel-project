                ...
                @foreach($zwierzeta as $zwierze)
                    <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition">
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200">
                            <a href="{{ route('client.zwierze.karta', $zwierze->id) }}" 
                               class="w-full inline-flex justify-center items-center gap-2 bg-teal-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-teal-700 transition">
                ...
                <table class="w-full">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-gray-700 font-semibold">Temperatura</th>
                            <th class="px-6 py-4 text-left text-gray-700 font-semibold">Przepisane leki</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                        @foreach($wizyty as $wizyta)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    @if($wizyta->dokumentacjaMedyczna && $wizyta->dokumentacjaMedyczna->temperatura)
                                        <span class="font-medium">{{ number_format($wizyta->dokumentacjaMedyczna->temperatura, 1, ',', '') }}°C</span>
                                    @else
