...
@section('content')
<section class="min-h-[70vh] flex items-center justify-center py-12 px-4" aria-labelledby="register-heading">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        <div class="text-center mb-8">
            <div class="flex justify-center mb-4">
                <svg class="w-12 h-12 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
                </svg>
            </div>
            <h1 id="register-heading" class="text-3xl font-bold text-gray-800">Rejestracja</h1>
        ...
        <form method="POST" action="{{ route('register.submit') }}" aria-label="Formularz rejestracji">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    <label for="imie" class="block text-gray-700 font-semibold mb-2">
                        Imię <span class="text-red-600" aria-hidden="true">*</span><span class="sr-only">(pole wymagane)</span>
                    </label>
                    <input 
                        type="text" 
                        id="imie" 
                ...
                <div>
                    <label for="nazwisko" class="block text-gray-700 font-semibold mb-2">
                        Nazwisko <span class="text-red-600" aria-hidden="true">*</span><span class="sr-only">(pole wymagane)</span>
                    </label>
                    <input 
                        type="text" 
                        id="nazwisko" 
            ...
            <div class="mb-6">
                <label for="haslo_confirmation" class="block text-gray-700 font-semibold mb-2">
                    Potwierdź hasło <span class="text-red-600" aria-hidden="true">*</span><span class="sr-only">(pole wymagane)</span>
                </label>
                <input 
                    type="password" 
        ...
        <aside class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg" aria-label="Informacja o koncie">
