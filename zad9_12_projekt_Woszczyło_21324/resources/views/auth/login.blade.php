...
@section('content')
<div class="min-h-[70vh] flex items-center justify-center py-12 px-4 bg-gradient-to-b from-gray-50 to-white">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 border border-gray-100 transform hover:scale-[1.01] transition-all duration-300">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Logowanie</h1>
        ...
        <form method="POST" action="{{ route('login.submit') }}" aria-label="Formularz logowania">
            ...
            <div class="mb-6">
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox" name="remember" id="remember" class="form-checkbox h-5 w-5 text-teal-600 rounded border-gray-300 focus:ring-teal-500 transition-all" aria-describedby="remember-help">
                    <span class="ml-2 text-gray-700" id="remember-help">Zapamiętaj mnie na tym urządzeniu</span>
                </label>
            </div>
