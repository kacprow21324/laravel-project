...
@section('content')
    ...
    <section class="relative min-h-[80vh] flex items-center justify-center" style="background-image: url('{{ asset('image/tlo.jpg') }}'); background-size: cover; background-position: center; background-attachment: fixed;" aria-labelledby="hero-heading">
        ...
        <div class="container mx-auto px-4 text-center relative z-10 py-20">
            <!-- Ikona serca -->
            <div class="flex justify-center mb-8 animate-pulse" aria-hidden="true">
                <div class="bg-white/10 backdrop-blur-sm rounded-full p-6 shadow-2xl">
                    <svg class="w-20 h-20 text-white drop-shadow-2xl" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <!-- Główny napis -->
            <h1 id="hero-heading" class="text-5xl md:text-7xl font-extrabold mb-6 text-white drop-shadow-2xl leading-tight">
                ...
                @guest
                    <a href="{{ route('login') }}" class="group bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-8 py-4 rounded-2xl font-bold text-xl hover:from-teal-600 hover:to-cyan-600 transition-all duration-300 shadow-2xl transform hover:scale-105 hover:shadow-teal-500/50">
                        <span class="flex items-center gap-2">
                            <svg class="w-6 h-6 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="mt-16 animate-bounce" aria-hidden="true">
                <svg class="w-8 h-8 mx-auto text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <!-- O nas Section -->
    <section id="o-nas" class="py-20 bg-white" aria-labelledby="o-nas-heading">
        <div class="container mx-auto px-4">
            <h2 id="o-nas-heading" class="text-4xl font-bold text-center mb-4 text-gray-800">O Nas</h2>
    ...
    <!-- Oferta Section -->
    <section id="oferta" class="py-20 bg-gradient-to-b from-gray-50 to-white" aria-labelledby="oferta-heading">
        <div class="container mx-auto px-4">
            <h2 id="oferta-heading" class="text-4xl font-bold text-center mb-4 text-gray-800">Nasza Oferta</h2>
            <p class="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
                Oferujemy szeroki zakres usług weterynaryjnych dostosowanych do potrzeb Twojego pupila.
            </p>
            <div class="grid md:grid-cols-4 gap-6">
                <article class="group bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105 border border-gray-100">
    ...
    <!-- CTA Section -->
    <section class="py-20 bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 text-white relative overflow-hidden" aria-labelledby="cta-heading">
        <!-- Decorative elements -->
        <div class="absolute top-0 left-0 w-72 h-72 bg-white/10 rounded-full -translate-x-1/2 -translate-y-1/2" aria-hidden="true"></div>
        <div class="absolute bottom-0 right-0 w-96 h-96 bg-white/5 rounded-full translate-x-1/3 translate-y-1/3" aria-hidden="true"></div>
        
        <div class="container mx-auto px-4 text-center relative z-10">
            <h2 id="cta-heading" class="text-4xl md:text-5xl font-bold mb-6 drop-shadow-lg">Umów wizytę już dziś!</h2>
            ...
            <div class="flex justify-center gap-4 flex-wrap">
                <a href="tel:+48123456789" class="group bg-white text-teal-700 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-gray-100 transition-all duration-300 flex items-center gap-2 shadow-2xl transform hover:scale-105">
                    <svg class="w-6 h-6 group-hover:animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
